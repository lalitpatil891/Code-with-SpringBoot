...
public class BootIocProj06LayeredAppMiniProjectRealtimeDIApplication {
	...
	public static void main(String[] args) {
		...
		try(ConfigurableApplicationContext ctx=
				 SpringApplication.run(BootIocProj06LayeredAppMiniProjectRealtimeDIApplication.class, args);

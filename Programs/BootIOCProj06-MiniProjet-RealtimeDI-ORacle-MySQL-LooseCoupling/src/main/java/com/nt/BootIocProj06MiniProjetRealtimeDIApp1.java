...
public class BootIocProj06MiniProjetRealtimeDIApp1 {
	...
	public static void main(String[] args) {
		...
		//get IOC container
		try(ConfigurableApplicationContext ctx=SpringApplication.run(BootIocProj06MiniProjetRealtimeDIApp1.class, args)){

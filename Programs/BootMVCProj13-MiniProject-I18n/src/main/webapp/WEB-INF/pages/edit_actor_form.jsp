...
<frm:form   modelAttribute="actor">
  <table   bgcolor="cyan"  align="center">
     <tr>
       <th> <sp:message  code="edit.label1"/>:: </th>
       <th>  <frm:input type="text"  path="aid" readonly="true"/> </th>
     </tr>
     <tr>
       <th> <sp:message  code="edit.label2"/>:: </th>
       <th>  <frm:input type="text"  path="aname"/> </th>
     </tr>
     <tr>
       <th> <sp:message  code="edit.label3"/>:: </th>
       <th>  <frm:input type="text"  path="addrs"/> </th>
     </tr>
     <tr>
       <th> <sp:message  code="edit.label4"/>:: </th>
       <th>  <frm:input type="text"  path="category"/> </th>
     </tr>
     <tr>
       <th> <sp:message  code="edit.label5"/>:: </th>
       <th>  <frm:input type="text"  path="fee"/> </th>
     </tr>
     <tr>
        <th> <input type="submit"  value="<sp:message  code="edit.submit"/>"> </th>

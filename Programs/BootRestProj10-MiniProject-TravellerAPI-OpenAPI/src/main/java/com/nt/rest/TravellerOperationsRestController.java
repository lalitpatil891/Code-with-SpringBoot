...
@Tag(name = "Traveller API", description = "API realted Travel passsion person")
public class TravellerOperationsRestController {
	...
	*/
	...
	@PostMapping("/save")   //endpoint1
	@Operation(
            summary = "register the Traveller",
            description = "keeps the Traveller information in the DB s/w"
    )
	public   ResponseEntity<String>  registerTraveller(@RequestBody   TravellerVO  vo){
			//use service
			String  msg=travellerService.registerTraveller(vo);
